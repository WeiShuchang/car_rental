...
SECRET_KEY = 'django-insecure-&17t!ge=^)e*m))-^q4z7+riiu-$!+%nk62i2k8neuq%vzim4#'
DEBUG = True
ALLOWED_HOSTS = ['192.168.1.17', '127.0.0.1','192.168.1.158']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sanchezmaronharvey@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'ckrb suwk aczb vemf'
DEFAULT_FROM_EMAIL = 'sanchezmaronharvey@gmail.com'